...
<div class="flex flex-row bg-white border-2 border-gray-400 rounded-xl w-[40rem] h-[3.75rem] items-center focus-within:border-orange-500">
	...
	<div class="relative group font-lato text-gray-700">
		<button class="mx-4 flex flex-row items-center dropdown border-2 border-gray-300 rounded pl-3 pr-2">
			{condition} <iconify-icon class="text-lg" icon="gridicons:dropdown"></iconify-icon>
		</button>
		<div class="absolute p-3 w-[10rem] bg-white rounded-lg shadow-xl dropdown-content hidden group-hover:flex flex-col items-start z-10">
